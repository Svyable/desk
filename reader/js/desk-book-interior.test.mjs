...
import { interiorStyleHref, upstreamInteriorSources } from './desk-book-interior.js';
...
match(styleHref, /\/reader\/css\/desk-book-interior\.css\?v=bookself-fc056870$/);

const upstream = upstreamInteriorSources();
equal(upstream.module, 'https://raw.githubusercontent.com/Svyable/bookself/fc056870d666a52b3f65684a05968238dc94a712/reader/js/book-interior.js');
equal(upstream.style, 'https://raw.githubusercontent.com/Svyable/bookself/fc056870d666a52b3f65684a05968238dc94a712/reader/css/book-interior.css');
...
match(source, /raw\.githubusercontent\.com\/Svyable\/bookself\/fc056870d666a52b3f65684a05968238dc94a712\/reader\/js\/book-interior\.js/);
match(source, /raw\.githubusercontent\.com\/Svyable\/bookself\/fc056870d666a52b3f65684a05968238dc94a712\/reader\/css\/book-interior\.css/);
match(source, /new URL\('\.\.\/css\/desk-book-interior\.css\?v=bookself-fc056870', import\.meta\.url\)\.href/);
...
// The localized CSS is an exact minified adaptation of the pinned upstream
// paint-only layer. Guard the semantic surfaces that must stay aligned.
...
console.log(`Desk premium book interior provenance contract: ${assertions} assertions passed`);
