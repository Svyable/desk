...
match(adapter, /const LEGACY_SHORTCUT_KEYS = new Set\(\['b', 'f', 's', '\\/', '\\?'\]\)/);
match(adapter, /const LEGACY_NAV_KEYS = new Set\(\['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'PageUp', 'PageDown', 'Home', 'End', ' '\]\)/);
