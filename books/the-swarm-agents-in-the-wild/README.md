...
A narrative field guide to synthetic ecology: what changes when agents gain memory, tools, budgets, identity, reputation, and one another, then begin to participate in markets and institutions as a population rather than as isolated assistants.

## Contents

- [x] [Front Matter](manuscript/front-matter.md)
- [x] [Prologue — The Night Shift](manuscript/prologue-the-night-shift.md)

**Part I — Leaving the Terrarium**
...
**Part IV — Civilization for Nonhumans**

- [x] [Ch 14 — Rules Machines Can Read](manuscript/ch14-rules-machines-can-read.md)
- [x] [Ch 15 — The Right to Be Forgotten, the Duty to Remember](manuscript/ch15-the-right-to-be-forgotten-the-duty-to-remember.md)
- [x] [Ch 16 — Immune Systems](manuscript/ch16-immune-systems.md)
- [x] [Ch 17 — The Constitutional Layer](manuscript/ch17-the-constitutional-layer.md)
...
- [x] [Ch 29 — Field Notes for the Swarm](manuscript/ch29-field-notes-for-the-swarm.md)

- [x] [Notes to the Field Edition](manuscript/notes-to-the-field-edition.md)
- [x] [Epilogue — A Walk Through the Swarm](manuscript/epilogue-a-walk-through-the-swarm.md)
