...
That repetition creates a natural laboratory if we resist turning every moment into a story.

Imagine recording a household for a month with a simple rule: before acting on an apparent request, the human writes down the prediction.

Door stance: likely outside.

Toy presentation: likely play.

Kitchen orientation after dinner: likely food solicitation.

Retreat during touch: likely seeking distance.

Then the human takes the smallest action that can test the interpretation and records what the dog does next.

The result would not reveal inner language.

It would reveal calibration.

How often is the person right?

Which signals are highly reliable?

Which depend on time or location?

Which are specific to one family member?

Which require repair?

Which apparent meanings disappear when the routine changes?

This is the empirical heart of the private-dialect idea.

It is also surprisingly accessible. The future research program does not need to begin with a billion-dollar animal foundation model. It can begin with better longitudinal observation of pairs.

The crucial requirement is prospective prediction because memory flatters us.

Humans remember the time the dog stared at the suitcase before a trip and forget the dozens of suitcase-adjacent moments that meant nothing. We remember the astonishing button combination and forget the ambiguous presses. We remember being “warned” before a storm after the storm occurs.

Write the prediction down first and the relationship becomes testable.

This does not make love less interesting.

It makes intimacy accountable.

A dog-human pair that truly has a private code should survive that accountability. Familiarity should produce measurable prediction advantages on at least some local signals. When the person is wrong, the dog’s repair strategy should reveal the mistake. When a stranger replaces the familiar human, some interactions should become less efficient until new contingencies form.

Those are falsifiable claims.

That is what turns the dog at the door from a charming metaphor into the beginning of a science.
