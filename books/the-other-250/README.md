...
**Reader links:** [Working edition · Desk Reader](https://svyable.github.io/desk/reader/#/b/the-other-250/)
...
The selections are arguments, not facts. Every chapter therefore carries a research trail, counter-evidence, and a falsification question: what would make this event a weaker choice for its decade? The book should surprise without cheating.

The 2020s are necessarily provisional. Chapter 26 is a first-edition judgment about a decade still underway, with current-policy claims bounded to the factual horizon above and intended for reassessment in later editions.
...
- [x] [Back Matter / Coda — The Country That Became Normal](manuscript/back-matter.md)
...
- [Machine-readable rights profile](rights.json)
