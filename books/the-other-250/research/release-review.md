...
Subsequent append-only remediation has closed four of those literal-baseline defects: Chapter 6 is 3,025 words, Chapter 11 is 3,047 words, Chapter 15 is 3,045, and Chapter 22 is 3,091 under the checker’s exact token expression. **Seventeen known sub-floor chapters remain.** These arithmetic closures do not substitute for the required final full-book checker run on one frozen committed source.
...
1. Deepen the remaining seventeen known sub-3,000-word chapters until every numbered chapter clears 3,000 words without padding or filler.
