# The Deal Wasn't an Acquisition

On June 12, 2025, Scale AI announced a transaction that looked, at first glance, like the kind of technology deal that had become ordinary after a decade of private-market excess. Meta was making what Scale called a "significant new investment." The price implied by the transaction valued Scale at more than $29 billion. Meta would end up with a minority position. Scale would remain independent.

Then came the line that made the structure harder to classify.

Alexandr Wang, Scale's founder and chief executive, was leaving the chief executive role to join Meta's artificial-intelligence effort.
...
In other words, "What did they buy?" is no longer answered by looking at the cap table.

Scale was a particularly revealing target because its business sat inside one of the least glamorous and most important layers of modern artificial intelligence: the production of data that helps models learn what people want and how experts judge.

Early machine-learning systems trained heavily on labeled examples: this image contains a stop sign; this object is a pedestrian; this text expresses positive sentiment. As models became more capable, the work did not disappear. It became more demanding. Frontier systems increasingly needed difficult evaluations, expert-written examples, preference judgments, safety testing, coding tasks, mathematical reasoning, domain-specific feedback, and other forms of information that cannot be collected by pointing a crawler at the public internet and calling the result knowledge.

That change pushed data and talent into the same room.

A difficult reasoning example is data after it has passed through a capable mind. An expert evaluation is simultaneously a labor product and a training signal. A red-team finding is an observation created by someone who understood how to make a system fail. The distinction between information and the people who produce useful information becomes porous at the frontier.

Scale had built itself in that seam.

This is one reason the Meta transaction is a better opening for this book than a story about a warehouse full of servers. The physical infrastructure of AI is vast, expensive, and essential. Meta's own 2025 annual report said the company spent nearly $70 billion on property and equipment that year and expected 2026 capital expenditures of roughly $115 billion to $135 billion, largely to support AI and its core business. Those numbers make the new industrial scale impossible to ignore.

But money can buy machines more easily than it can buy an operating loop.

A company can order accelerators. It can lease data-center capacity. It can write checks for models, vendors, consultants, and cloud contracts. The harder question is whether those inputs produce a system that becomes better through use.

The Scale deal sat directly on that question. Meta had distribution on a scale few organizations in history had possessed. Its products reached billions of people. It had enormous capital resources and the ability to finance infrastructure at levels that would make most companies uninvestable. What it wanted more of was the scarce layer between raw compute and global distribution: people who could improve the models, and data processes that could accelerate improvement.

Scale's founder was one of those people. Scale's data infrastructure was one of those processes. Yet customer information remained fenced off.

That fence matters.

Business writing has spent two decades calling data "the new oil," a metaphor that survives because it is memorable and fails because it is mechanically wrong. Oil is depleted when used. Data can be copied. Oil does not become more useful because a customer corrects it. Data often does. Two barrels of the same grade are deliberately interchangeable. Two datasets containing the same number of rows may differ radically in provenance, freshness, rights, coverage, error, context, and connection to outcomes.

Most important, possession of data does not imply permission to turn it into whatever advantage a company wants.

OpenAI, for example, has publicly described a training-data mixture that includes public information, proprietary data partnerships, and human feedback from trainers, red teamers, employees, and users whose settings permit contribution. At the same time, it says business customer data is not used for model training by default. Those two statements belong together. Modern AI systems need data. Modern AI businesses also need boundaries around data.

The productive asset is therefore not a pile of information. It is an information relationship.

A company observes something. It has the legal and technical right to use the observation for a defined purpose. Someone or something inside the company can connect the observation to an outcome. The organization can change its behavior because of what it learned. The changed behavior produces another observation.

Now the data begins to compound.

This is easy to see in recommendation systems. A platform shows a person something. The person watches, skips, clicks, buys, saves, hides, shares, or leaves. The response becomes evidence about the quality of the previous decision. The system updates. The next recommendation changes.

The same structure appears in less visible businesses. A logistics network learns which routes fail under certain conditions. A fraud system learns from confirmed cases. A sales organization learns which combinations of buyer, message, price, and timing produce a contract. A software company sees where users abandon a workflow. A scientific group records which experimental conditions produced signal rather than noise. An intelligence organization combines collection with subsequent confirmation about which sources were reliable.

In each case, the organization is trying to close a loop between action and consequence.

The quality of that loop determines whether more data creates more intelligence or merely more storage expense.

Palantir's public filings offer a useful contrast because the company sells software designed to help other organizations make use of their own dispersed information. In its 2025 annual report, Palantir said it had 954 customers and $4.5 billion in revenue, split across government and commercial work. The company describes its ambition as transforming how customers use data in pursuit of their goals. The important economic point is that Palantir does not need to own a customer's raw information for its software to become deeply embedded in the customer's decisions.

That is another way data creates leverage: through structure.

If a system becomes the place where an organization resolves identities, connects operational records, runs models, evaluates options, and pushes decisions back into the world, the value does not live in a static dataset. It lives in the map between information and action. Replacing the system can become difficult because the replacement must recreate that map while the organization keeps operating.

The moat, when there is one, is partly accumulated context.

This is where talent re-enters the story.
...
That phrase needs the word "partially." Tacit knowledge is not fully captured by a model because a statistical system can reproduce patterns without possessing every reason an expert would use in a novel situation. The study itself found heterogeneous effects. The best workers did not suddenly become 34 percent better simply because a model appeared. In some work, amplification compresses the gap between experienced and inexperienced people rather than giving the star unlimited superpowers.

This is precisely why talent and leverage should be studied together.
