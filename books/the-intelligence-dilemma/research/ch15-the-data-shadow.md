# Research Trail — Chapter 15: The Data Shadow
...
- Source: https://studentprivacy.ed.gov/privacy-and-data-sharing
- What it supports: FERPA generally restricts disclosure of personally identifiable information from education records without consent, while allowing specified exceptions under defined conditions. Guidance discusses written agreements and controls for disclosures to outside parties.
- Use in chapter: supports the legal baseline that school use of third-party systems handling education-record information is not ordinary consumer data sharing.

### U.S. Department of Education — Privacy and Education Technology

- Source: https://studentprivacy.ed.gov/privacy-and-education-technology
- What it supports: Department guidance treats online educational services, cloud services, terms of service, information collection, transmission, and vendor practices as student-privacy concerns that schools should evaluate.
- Use in chapter: supports the claim that procurement and terms of service are part of educational governance, not merely technical administration.

### U.S. Department of Education FAQ — online applications and FERPA

- Source: https://studentprivacy.ed.gov/faq/i-want-use-online-tool-or-application-part-my-course-however-i-am-worried-it-violation-ferpa
- What it supports: when a service receives PII from education records under the school-official exception, the service must perform an institutional service/function, remain under the school’s direct control regarding use and maintenance of the data, act consistently with FERPA notification requirements, and avoid unauthorized redisclosure/use. Teachers are told to use approved services and consult administrators/IT.
- Use in chapter: supports the practical claim that teachers cannot treat any convenient AI service as interchangeable when student information is involved.

### U.S. Department of Education — SPPO Guidance List (updated May 2026)

- Source: https://studentprivacy.ed.gov/resources/sppo-guidance-list
- What it supports: student privacy remains an active federal compliance area; the guidance set continues to cover FERPA and PPRA obligations and was updated in 2026.
- Use in chapter: establishes that the privacy framework is current and actively administered.

### Federal Trade Commission (2025), COPPA Rule amendments

- FTC summary: https://www.ftc.gov/news-events/news/press-releases/2025/01/ftc-finalizes-changes-childrens-privacy-rule-limiting-companies-ability-monetize-kids-data
- Final-rule page: https://www.ftc.gov/legal-library/browse/federal-register-notices/16-cfr-part-312-coppa-final-rule-amendments
- Published in the Federal Register: April 22, 2025.
- What it supports: the revised COPPA Rule strengthens protections including limits on indefinite retention, separate parental opt-in for certain third-party disclosures related to targeted advertising/other purposes, and expanded treatment of some identifiers.
- Use in chapter: supports the claim that U.S. children’s privacy law has recently moved toward stronger retention and third-party-use controls.
- Important limitation: COPPA applies to covered online services and children under 13; it is not a universal school-data law and should not be described as such.

### FTC (May 2026), COPPA six-step compliance guidance
...
- Source: https://studentprivacy.ed.gov/data-security-k-12-and-higher-education
...
- Audit privacy policies and data-processing agreements for major K-12 and higher-ed AI products.
- Compare data-retention defaults, model-training terms, deletion rights, and administrator access across vendors.
