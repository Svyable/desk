...
*Amped* asks what happens when the fastest-growing industrial customer in America is not a factory, a mine, or a smelter, but a warehouse of computers whose economic value depends on obtaining enormous quantities of electricity quickly.
...
The book should not claim that no prior author has discussed any one of these ideas. It should earn distinctiveness by connecting them carefully and by using 2024–2026 institutional changes as evidence that the customer-grid relationship is already being rewritten.
...
8. **Generation response:** Which resources actually respond to the demand shock — renewables, storage, natural gas, nuclear restarts, new nuclear, geothermal, or something else — and on what timelines?
...
The book should change if the evidence changes.

- Data-center demand forecasts are unusually uncertain. Announced interconnection requests are not the same as energized load, and many projects may be duplicated, delayed, resized, or canceled.
- Large electricity users are not automatically unique. Aluminum smelters, steel mills, refineries, chemical plants, semiconductor fabs, and other industrial facilities have long shaped utility systems and negotiated special rates.
- Data-center flexibility may be narrower than enthusiasts suggest. Real-time inference, contractual service levels, thermal limits, networking constraints, hardware utilization targets, and customer expectations can make some workloads difficult to move.
- Dedicated generation does not eliminate grid dependence. A co-located campus may still rely on transmission for backup, exports, startup, outages, balancing, or other services.
...
Use Lawrence Berkeley National Laboratory, DOE, EIA, IEA, NERC, PJM, ERCOT, and utility filings to separate measured consumption from scenarios and interconnection requests. Preserve vintages. A 2024 forecast and a 2026 forecast are evidence about how quickly expectations changed, not interchangeable estimates of one fixed future.

### II. The load-forecast problem

Follow how PJM, ERCOT, utilities, and regulators vet large-load requests. Record thresholds, study procedures, probability adjustments, and double-counting controls. Treat a queue as a list of proposals rather than a forecast of realized demand.
...
Use FERC's Susquehanna/PJM proceedings and subsequent co-location rules to distinguish electrically isolated facilities from facilities that remain synchronized with and dependent on the transmission system. Follow front-of-meter, behind-the-meter, and hybrid structures separately.

### V. Generation response

Track actual commercial commitments and regulatory status for nuclear restarts, life extensions, gas generation, renewables, storage, geothermal, and small modular reactors. Do not count a press release as operating capacity. Record expected in-service dates and approval dependencies.
...
Look for measured demonstrations, tariffs, or operational programs rather than treating theoretical workload mobility as proven grid capability. Distinguish batch training, model development, inference, storage, networking, cooling, and non-IT facility loads.

### VIII. Local political economy

Use state studies, commission proceedings, local tax agreements, water and land-use records, and utility filings. Avoid equating capital expenditure with local household benefit. Track who pays for roads, substations, water, transmission, tax incentives, and decommissioning or redevelopment risk.

### IX. Historical comparison

Compare data centers with electrochemical plants, aluminum smelters, defense factories, air conditioning, electrified manufacturing, and other load waves. The useful comparison is not "this happened before" but which institutional features truly differ: load density, speed, balance-sheet strength, geographic optionality, utilization, flexibility, and the relationship between physical location and product delivery.

## Chapter-to-evidence map

| Chapter | Primary research question |
|---|---|
| 1 — The 300-Megawatt Building | What changes when one customer arrives with the electric appetite of a small city or power plant? |
| 2 — The Grid Was Built Backward | How has American electricity historically responded to new categories of demand? |
| 3 — The Demand Shock | How large is the current data-center load wave, and how uncertain is it? |
| 4 — Northern Virginia Runs Into Physics | What happens when global compute demand concentrates in one utility and transmission zone? |
| 5 — The Queue on the Other Side | Why did large-load interconnection become a national regulatory problem? |
| 6 — The Forecast That Can Cost Billions | How can speculative load forecasts create real infrastructure obligations? |
| 7 — Who Pays for the Wire? | How are regulators redesigning rates so large loads carry the costs they cause? |
| 8 — Bring Your Own Power | What does co-location actually remove from the grid, and what does it leave behind? |
| 9 — The Reactor Next Door | Can long-term compute demand change the economics of existing and new nuclear power? |
| 10 — Gas on the Clock | Why does fast load growth create a market for dispatchable generation despite decarbonization goals? |
| 11 — Batteries Buy Time | Which data-center reliability functions can batteries serve, and where are their limits? |
| 12 — Compute Can Move | How geographically and temporally mobile is computation in practice? |
...
- Prefer primary regulators, grid operators, government datasets, utility filings, company filings, and original research.
- Separate measured load from forecast load, contract demand, interconnection requests, and public announcements.
- Never turn a project pipeline into operating capacity.
- Record the date or vintage of forecasts; rapid revision is part of the story.
- Distinguish megawatts of peak demand from megawatt-hours or terawatt-hours of annual consumption.
- Separate generation capacity from dependable capacity and from energy output.
- Treat company announcements as evidence of commercial intent, not independent proof of public benefit.
- Avoid invented quotations, private scenes, or internal motives.
- Identify federal/state jurisdiction carefully in discussions of transmission, retail rates, generation, and utility planning.
- Preserve the strongest cost-shifting and stranded-asset countercase in every chapter that argues data centers can accelerate grid investment.
- For every major claim, keep the practical question: **What would make this false?**
