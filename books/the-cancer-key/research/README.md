...
The Cancer Key tests a deliberately strong proposition: neoantigens have solved a central targeting problem in cancer immunology by allowing therapies to distinguish malignant cells through mutation-derived features absent from normal tissue, but the scientific breakthrough does not by itself solve cancer or guarantee broad public benefit.
...
1. Which kinds of tumor alterations generate neoantigens that are actually presented and recognized by T cells?
2. How accurately can current HLA and antigen-presentation systems rank patient-specific targets, and where do prediction quality and training data vary by HLA allele or population?
...
Every chapter should preserve evidence against the book's strongest framing.
...
- Strong intellectual property can be necessary to finance late-stage biotechnology development; public ownership is not automatically synonymous with public access.
- Direct-pay experimental treatment is not automatically illegitimate. Some jurisdictions allow physician-led individualized treatment, and expanded-access systems exist because trial-only access can be too restrictive for dying patients.
...
### I. Neoantigen biology

Use peer-reviewed reviews and original studies on tumor-specific mutation-derived antigens, HLA presentation, T-cell recognition, clonality, immune escape and tumor microenvironment. Distinguish prediction from measured presentation and measured presentation from clinical efficacy.
