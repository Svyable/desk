# Gatekeepers — chapter evidence notes

These files preserve chapter-level source selection, claim boundaries, counterevidence, and forward research links. They supplement the cross-book [`source-ledger.csv`](../source-ledger.csv).
