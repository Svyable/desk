...
Every new strategic commodity eventually gets compared with oil.

The comparison is irresistible because oil supplied the twentieth century with its clearest lesson in material power. A substance drawn from particular places became necessary to nearly every modern economy. Producing countries learned that coordinated restraint could change the price paid by consuming countries. Governments built military relationships around access, stockpiled emergency reserves, subsidized alternatives, redesigned vehicles, and spent half a century arguing about dependence.

So when lithium, cobalt, copper, nickel, graphite, and rare earths moved into national-security speeches, the language arrived already written.
