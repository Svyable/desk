...
- Joel Becker, Nate Rush, Beth Barnes, and David Rein, METR, “Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity” (July 10, 2025): randomized study of 16 experienced developers completing 246 real tasks in familiar repositories. Allowing early-2025 AI tools increased completion time by 19% in that setting despite participants expecting a 24% speedup beforehand and perceiving a 20% speedup afterward. METR explicitly cautions that this result does not establish that AI slows most software developers. https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/
- METR, “We are Changing our Developer Productivity Experiment Design” (February 24, 2026): a crucial update to the preceding result. In a later experiment using newer tools, raw estimates moved toward speedups, but METR concluded that non-participation by developers unwilling to work without AI, lower compensation, and difficulty measuring concurrent-agent work made the new data an unreliable estimate of the current productivity effect. METR says it is likely developers were more sped up in early 2026 than in the early-2025 study, while stressing that the later data is only weak evidence for the size of the change. https://metr.org/blog/2026-02-24-uplift-update/
...
Counterevidence preserved in the chapter: delegation costs can rise when briefing is difficult, context is missing, expert workflows are interrupted, outputs are hard to verify, or subtle errors make review expensive. The 2025 METR slowdown should be presented as a dated, unusually demanding setting rather than as a durable estimate of developer productivity: METR's 2026 follow-up suggests the sign may already have changed while also showing why fast-moving productivity measurement can become harder as adoption itself changes who will participate in a no-AI control condition. The chapter therefore makes no universal productivity claim and should treat the frontier as moving.
