...
**Reader links:** [Working edition · Desk Reader](https://svyable.github.io/desk/reader/#/b/the-waiting-list/)
...
The central thesis is that when a price cannot or should not allocate a scarce good, some other rule always fills the vacuum — a queue, a lottery, a priority rule, or an algorithmic match — and that rule is rarely neutral. The book follows the economists who turned this problem into a rigorous discipline (market design), from the 1962 mathematics of stable matching through the National Resident Matching Program, kidney exchange, and school choice, then traces the same mechanism into ride-hailing, dating apps, pandemic vaccine rollout, refugee resettlement, AI-compute rationing, water rights, housing lotteries, and college admissions, closing with who audits these systems and how to build a better one.
...
- [x] [Ch 6 — The Marriage Algorithm](manuscript/ch06-the-marriage-algorithm.md)
- [x] [Ch 7 — The Man Who Fixed the Medical Match](manuscript/ch07-the-man-who-fixed-the-medical-match.md)
...
- [x] [Ch 12 — Dating by Algorithm](manuscript/ch12-dating-by-algorithm.md)
...
- [x] [Ch 17 — The Housing Lottery](manuscript/ch17-the-housing-lottery.md)
- [x] [Ch 18 — The Line for College](manuscript/ch18-the-line-for-college.md)
- [x] [Ch 19 — Who Audits the Algorithm](manuscript/ch19-who-audits-the-algorithm.md)
- [x] [Ch 20 — How to Build a Better Waiting List](manuscript/ch20-how-to-build-a-better-waiting-list.md)
- [x] [Epilogue — The Next Call](manuscript/epilogue-the-next-call.md)
