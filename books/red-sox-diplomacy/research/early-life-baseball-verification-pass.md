...
The same entry says the writer saw Sanford complete a 2002 run across America at Fenway Park's Green Monster and calls Sanford a fellow member of Red Sox Nation.

Sources:
- Legacy.com condolence / obituary page for Paul Sanford:
  https://www.legacy.com/obituaries/name/paul-sanford-obituary?pid=85809700
- Boston Globe / Legacy rendering:
  https://www.legacy.com/us/obituaries/bostonglobe/name/paul-sanford-obituary?id=25728918
- Telegraph / Legacy rendering:
  https://www.legacy.com/us/obituaries/macon/name/paul-sanford-obituary?id=25289508

## Why the attribution is now very high-confidence
...
**Status: very high-confidence Burns-authored first-person memory; still not formally authenticated enough for silent conversion into unqualified fact.**
...
For a heavily sourced trade manuscript, an attributed version may now be usable if the qualification is worth the narrative space. The cleaner course remains to obtain one more independent identifier before treating the memory as ordinary biographical fact.

The unsafe formulation, until corroborated, is:

> Nicholas Burns met Paul Sanford playing Little League baseball in Wellesley.

The difference matters because online condolence pages ordinarily do not verify the real-world identity of a signer.

## What would authenticate it
...
5. Sanford family papers, obituary materials, or correspondence identify Ambassador Burns as the guestbook writer.
6. A contemporaneous 2002 Run America account identifies Burns among the Fenway supporters.

## Wellesley archive targets

The Wellesley Free Library identifies two especially relevant digitized collections:

- **Wellesleyan yearbooks, 1931–2018**, available through the Internet Archive.
- **Wellesley Townsman, 1906–2005**, available through the library's historical newspaper resources.

Library databases page:
https://www.wellesleyfreelibrary.org/discover-borrow/digital-resources/databases/
...
This guestbook lead is additive rather than foundational. We already have stronger direct evidence from ESPN that Burns says his playing career peaked in the **Wellesley Babe Ruth League**.

That means the manuscript can already state that Burns played organized youth baseball in Wellesley. The guestbook matters because, if authenticated, it pushes the documented playing history earlier into Little League and supplies the name of a childhood baseball friend.

## Manuscript rule

Do not build a reconstructed childhood scene around this source. Do not infer field, position, uniform, coach, inning, family attendance, or conversation.

Until authenticated, either keep it in research notes or attribute it explicitly as the signed guestbook entry. If corroborated, it becomes a valuable bridge between Burns's own Babe Ruth League recollection and the larger Wellesley/Red Sox formation chapter.
