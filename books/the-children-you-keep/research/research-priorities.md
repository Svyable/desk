...
## Highest-value primary work

1. Build a paper-by-paper quantitative table of long-term maternal microchimerism: cohort size, pregnancy history, source marker, tissue, total genomes/cells assayed, detection threshold, prevalence, concentration and maximum interval since pregnancy.
2. Reconstruct the full Bianchi 1996 experimental pipeline and later technical replications using original methods rather than reviews.
...
## Decisive prospective cohort

Enroll mother-father-fetus trios with genome-wide genotyping and pre-pregnancy maternal blood where available. Track pregnancy-specific alleles in intact-cell fractions and cell-free plasma separately. Sample during pregnancy, delivery and long postpartum intervals. Bank sorted immune and progenitor compartments. Record transfusion, transplant, twin and pregnancy-loss history.
...
Use prospective biobanks with prediagnostic blood. Family-genotype cases and controls. Determine whether pregnancy-specific microchimerism precedes cancer and whether particular immune clones predict incidence. In cases, look for those exact clones in tumor tissue and test antigen reactivity.

## Decisive autoimmune test

Find preclinical samples from women who later develop systemic sclerosis or autoimmune thyroid disease. If disease-associated microchimeric enrichment is absent before inflammatory markers and appears only after disease, broad initiation claims should weaken sharply.

## Defeat conditions for the book's stronger synthesis

The claim that microchimerism is a meaningful long-term physiological system should be reduced if:
...
The synthesis should strengthen if:
...
## Anti-padding rule for manuscript expansion

Expansion toward Desk's 65,000-word full-book standard must come from original methods, quantitative results, competing studies, cell biology, immunology and longitudinal designs. Do not add repeated meditations on identity, motherhood or “cells that remain.” Every additional thousand words should add an experiment, a contradiction, a mechanism or a measurement problem.