...
<!-- DESK_SUMMARY:START -->
> **Desk: 59 book projects · 25 complete drafts · 1 in revision · 33 drafting**
<!-- DESK_SUMMARY:END -->

<!-- SHELF_SUMMARY:START -->
> **Shelf: 14 author projects · 11 released · 3 public drafts/proofs**
> **Where they live: 14 in both Desk + Shelf · 44 Desk-only · 0 Shelf-only**
> **Release review queue: 15 complete Desk manuscripts are not finally released — 14 are Desk-only and 1, Public Pressure, is already on Shelf as a public proof.** `Complete draft` means manuscript-complete, not automatically approved for release.
...
| [**The Want Machine**](books/the-want-machine/) | ✍️ Drafting | 0 of 20 | 33 | The working thesis is that the twentieth century built an enormous machinery for influencing what people want — advertising, database marketing, recommendation engines, choice architecture… | [Read →](https://svyable.github.io/desk/reader/#/b/the-want-machine/) |
