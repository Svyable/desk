...
<!-- DESK_SUMMARY:START -->
> **Desk: 56 book projects · 23 complete drafts · 1 in revision · 32 drafting**
<!-- DESK_SUMMARY:END -->
...
| [**Austerity Measures**](books/austerity-measures/) | ✅ Complete draft | 12 / 12 | ~18K | Artificial intelligence can make public administration dramatically cheaper while leaving judgment, legitimacy, maintenance, technical competence, and the capacity to act scarce. | [Read →](https://svyable.github.io/desk/reader/#/b/austerity-measures/) |
...
| [**Fiscal Wall**](books/fiscal-wall/) | ✅ Complete draft | 18 of 18 | ~70K | A market-structure account of the Treasury refinancing cycle: auctions, dealers, repo, foreign demand, the Fed, and what higher rates do to fiscal room. | [Read →](https://svyable.github.io/desk/reader/#/b/fiscal-wall/) |
...
| [**The Swarm: Agents in the Wild**](books/the-swarm-agents-in-the-wild/) | ✍️ Drafting | 29 of 29 working chapters | ~29K | A narrative field guide to synthetic ecology: what changes when agents gain memory, tools, budgets, identity, reputation, and one another, then begin to participate in markets and institutions as a population rather than as isolated assistants. | [Read →](https://svyable.github.io/desk/reader/#/b/the-swarm-agents-in-the-wild/) |
