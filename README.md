...
<!-- DESK_SUMMARY:START -->
> **Desk: 91 book projects · 44 complete drafts · 2 in revision · 45 drafting**
<!-- DESK_SUMMARY:END -->

<!-- SHELF_SUMMARY:START -->
> **Shelf: 42 author projects · 40 released · 2 public drafts/proofs**
> **Where they live: 42 in both Desk + Shelf · 49 Desk-only · 0 Shelf-only**
...
| [**Gradient Ascent**](books/gradient-ascent/) | ✍️ Drafting | 8 of 24 drafted | — | The working thesis is that generative AI changes the information problem from scarcity to saturation. | [Read →](https://svyable.github.io/desk/reader/#/b/gradient-ascent/) |
...
| [**The Alliance Advantage**](books/the-alliance-advantage/) | ✍️ Drafting | 1 of 18 + prologue | — | The working thesis is that alliances create durable power only when political promises become interoperable systems. | [Read →](https://svyable.github.io/desk/reader/#/b/the-alliance-advantage/) |
...
| [**The Taiwan Threshold**](books/the-taiwan-threshold/) | ✍️ Drafting | 1 of 18 + prologue | — | The working thesis is that the most dangerous path to a Taiwan conflict is not necessarily a single decision to invade but a sequence of coercive moves below the traditional threshold of war. | [Read →](https://svyable.github.io/desk/reader/#/b/the-taiwan-threshold/) |
...
| [**The Warning Problem**](books/the-warning-problem/) | ✍️ Drafting | 1 of 18 + prologue | — | The working thesis is that artificial intelligence can improve nuclear-warning analysis while making the decision environment faster, more complex, and more vulnerable to false confidence. | [Read →](https://svyable.github.io/desk/reader/#/b/the-warning-problem/) |
...
| [**The World Won’t Choose Sides**](books/the-world-wont-choose-sides/) | ✍️ Drafting | 1 of 18 + prologue | — | The working thesis is that the defining geopolitical fact of the next decade is not a clean division between American and Chinese blocs but the growing leverage of states able to bargain issue by issue. | [Read →](https://svyable.github.io/desk/reader/#/b/the-world-wont-choose-sides/) |
