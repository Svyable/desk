...
<!-- SHELF_SUMMARY:START -->
> **Shelf: 36 author projects · 34 released · 2 public drafts/proofs**
> **Where they live: 36 in both Desk + Shelf · 31 Desk-only · 0 Shelf-only**
...
**Desk-only complete drafts awaiting an explicit release decision:** [America's Got a Spending Problem](books/americas-got-a-spending-problem/), [Useful Noise](books/useful-noise/)
<!-- SHELF_SUMMARY:END -->
...
| [**Chokepoint**](books/chokepoint/) | ✍️ Drafting | 9 of 20 | 23,482 | The working thesis is that the twenty-first century is being rebuilt around a short list of elements — copper, lithium, cobalt, nickel, and the seventeen rare earths — the way the… | [Read →](https://svyable.github.io/desk/reader/#/b/chokepoint/) |
