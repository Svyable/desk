...
| [**No One Read It**](books/no-one-read-it/) | ✍️ Drafting | 5 of 21 | ~16K | Generative systems can produce contracts, code, analysis, reports, messages, and options faster than the people named on that work can inspect it. | [Read →](https://svyable.github.io/desk/reader/#/b/no-one-read-it/) |
