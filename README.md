...
| [**No One Read It**](books/no-one-read-it/) | ✍️ Drafting | 1 of 21 | 3,808 | Generative systems can produce contracts, code, analysis, reports, messages, and options faster than the people named on that work can inspect it. | [Read →](https://svyable.github.io/desk/reader/#/b/no-one-read-it/) |
