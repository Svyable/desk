...
<!-- SHELF_SUMMARY:START -->
> **Shelf: 23 author projects · 21 released · 2 public drafts/proofs**
> **Where they live: 23 in both Desk + Shelf · 41 Desk-only · 0 Shelf-only**
> **Release review queue: 13 complete Desk manuscripts are not finally released — all 13 are Desk-only.** `Complete draft` means manuscript-complete, not automatically approved for release.
...
| [**America's Got a Spending Problem**](books/americas-got-a-spending-problem/) | ✍️ Drafting | 18 of 18 | 30,252 | Working manuscript in Svyable Desk. | [Read →](https://svyable.github.io/desk/reader/#/b/americas-got-a-spending-problem/) |
...
| [**Chokepoint**](books/chokepoint/) | ✍️ Drafting | 2 of 20 | ~8K | The working thesis is that the twenty-first century is being rebuilt around a short list of elements — copper, lithium, cobalt, nickel, and the seventeen rare earths — the way the twentieth century was rebuilt around oil. | [Read →](https://svyable.github.io/desk/reader/#/b/chokepoint/) |
...
| [**Make Yourself Useful**](books/make-yourself-useful/) | ✍️ Drafting | 3 of 12 | 10,837 | The book follows ordinary people who notice the unclaimed problem, carry more than their official job requires, and turn small acts of usefulness into trust, access, and eventually freedom. | [Read →](https://svyable.github.io/desk/reader/#/b/make-yourself-useful/) |
| [**Open Source**](books/open-source/) | ✅ Complete draft | 18 of 18 | 72,044 | The central thesis is that open AI does not abolish ownership; it rearranges it. | [Read →](https://svyable.github.io/desk/reader/#/b/open-source/) |
| [**Orbital**](books/orbital/) | ✍️ Drafting | Prologue + 4 complete chapters + 1 chapter stub; 21 chapters planned | 7,217 | A narrative history of how low Earth orbit changed from a government-run domain of bespoke spacecraft into an industrial layer increasingly launched, manufactured, networked, and operated… | [Read →](https://svyable.github.io/desk/reader/#/b/orbital/) |
| [**Predictable**](books/predictable/) | ✍️ Drafting | 12 of 12 | 27,887 | The working thesis is that societies repeatedly make the same mistake around transformative technologies: they correctly recognize that something important has arrived, then misprice how… | [Read →](https://svyable.github.io/desk/reader/#/b/predictable/) |
...
| [**The Cancer Key**](books/the-cancer-key/) | ✅ Complete draft · Published on Shelf | 28 of 28 | ~85K | A trade-nonfiction investigation of the moment cancer immunology learned to turn a tumor's private mutations into addresses for vaccines and T cells—and of the companies, public research systems, factories, algorithms, patents and clinics that now determine who can use the breakthrough. | [Read →](https://svyable.github.io/desk/reader/#/b/the-cancer-key/) |
...
| [**Triumph of the Commons**](books/triumph-of-the-commons/) | ✅ Complete draft · Published on Shelf | 20 of 20 | 71,461 | The central thesis is that artificial intelligence changes the economics of helping. | [Read →](https://svyable.github.io/desk/reader/#/b/triumph-of-the-commons/) |
...
| [**Wild Speculation**](books/wild-speculation/) | ✅ Complete draft | 20 / 20 | 63,900 | Working manuscript in Svyable Desk. | [Read →](https://svyable.github.io/desk/reader/#/b/wild-speculation/) |
<!-- DESK_CATALOG:END -->
