...
<!-- SHELF_SUMMARY:START -->
> **Shelf: 24 author projects · 22 released · 2 public drafts/proofs**
> **Where they live: 24 in both Desk + Shelf · 40 Desk-only · 0 Shelf-only**
...
|---|---|---:|---:|---|---|
| [**Adjacency**](books/adjacency/) | ✅ Complete draft · Published on Shelf | 25 of 25 | 74,375 | This Desk copy remains the working source for future revisions. The first public edition was intentionally snapshotted to Svyable Shelf in September 2026; later Desk edits do not silently… | [Read →](https://svyable.github.io/desk/reader/#/b/adjacency/) |
...
| [**Allocating Intelligence**](books/allocating-intelligence/) | ✅ Complete draft | 20 of 20 | 58,675 | The book treats intelligence as an allocatable resource rather than a magical property. | [Read →](https://svyable.github.io/desk/reader/#/b/allocating-intelligence/) |
...
| [**Chokepoint**](books/chokepoint/) | ✍️ Drafting | 6 of 20 | 16,416 | The working thesis is that the twenty-first century is being rebuilt around a short list of elements — copper, lithium, cobalt, nickel, and the seventeen rare earths — the way the… | [Read →](https://svyable.github.io/desk/reader/#/b/chokepoint/) |
...
| [**Gatekeepers**](books/gatekeepers/) | ✍️ Drafting | 17 of 21 | 56,606 | This is an unpublished Desk manuscript. Its central argument is that modern power often sits at transitions: between outside and inside, applicant and approved, developer and customer… | [Read →](https://svyable.github.io/desk/reader/#/b/gatekeepers/) |
...
| [**Open Source**](books/open-source/) | ✅ Complete draft | 18 of 18 | 74,879 | The central thesis is that open AI does not abolish ownership; it rearranges it. | [Read →](https://svyable.github.io/desk/reader/#/b/open-source/) |
| [**Orbital**](books/orbital/) | ✍️ Drafting | Prologue + 8 complete chapters; 21 chapters planned | 19,138 | A narrative history of how low Earth orbit changed from a government-run domain of bespoke spacecraft into an industrial layer increasingly launched, manufactured, networked, and operated… | [Read →](https://svyable.github.io/desk/reader/#/b/orbital/) |
...
| [**The Measure of Good**](books/the-measure-of-good/) | ✍️ Drafting | 13 of 18 | 45,808 | A book about metrics, judgment, and the point where measurement stops and moral choice begins. | [Read →](https://svyable.github.io/desk/reader/#/b/the-measure-of-good/) |
